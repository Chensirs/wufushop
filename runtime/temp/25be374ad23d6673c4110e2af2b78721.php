<?php if (!defined('THINK_PATH')) exit(); /*a:1:{s:43:"./application/admin/view/index\welcome.html";i:1496819690;}*/ ?>
<html>
<head>
...
<body class="iframe_body">
                    ...
                    <div class="sc_warp">
                    	<div class="item_section item_section_frist">
                            ...
                            <div class="section_body">
                            	<dl>
                                	<dt>商城首页：</dt>
                                    <dd><a href="" target="_blank">http://www.wufuic.com/</a></dd>
                                </dl>
                                <dl>
                                	<dt>平台后台：</dt>
                                    <dd><a href="" target="_blank">http://www.wufuic.com/admin</a></dd>
                                </dl>
                                <dl>
                                	<dt>商家后台：</dt>
                                    <dd><a href="" target="_blank">http://www.wufuic.com/seller</a></dd>
                                </dl>
                                <dl>
                                	<dt>门店后台：</dt>
                                    <dd><a href="" target="_blank">http://www.wufuic.com/stores</a></dd>
                                </dl>
                                <dl>
                                	<dt>WAP首页：</dt>
                                    <dd><a href="" target="_blank">http://www.wufuic.com/mobile</a></dd>
                                </dl>
                            </div>
                        </div>
                        <div class="item_section">
                            ...
                            <div class="section_body">
                                ...
                                <dl>
                                	<dt>客服 QQ：</dt>
                                    <dd><a href="#" target="_blank">11111111</a></dd>
                                </dl>
                                <dl>
                                	<dt>问答反馈：</dt>
                                    <dd><a href="http://wenda.tpshop.com" target="_blank">http://www.wufuic.cn</a></dd>
                                </dl>
                                <dl>
                                	<dt>官方网站：</dt>
                                    <dd><a href="http://www.wufuic.com" target="_blank">http://www.wufuic.com</a></dd>
                                </dl>
                                <dl>
                                	<dt>官网：</dt>
                                    <dd><a href="http://www.wufuic.com" target="_blank">http://www.wufuic.com</a></dd>
    ...
    <p>版权所有 © 2017-2020 福建五福信息科技有限公司，并保留所有权利。</p>
</div>
