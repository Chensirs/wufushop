<?php if (!defined('THINK_PATH')) exit(); /*a:1:{s:43:"./template/pc/rainbow/uploadify\upload.html";i:1495621988;}*/ ?>
...
$("#SaveBtn").click(function(){	
	...
	if(num > 1){
			...
			$("input[name^='fileurl_tmp']").each(function(){
				fileurl_tmp += '<li rel="'+ this.value +'"><input class="input-text" type="text" name="<?php echo $info['input']; ?>[]" value="'+ this.value +'" /><a href="javascript:void(0);" onclick="ClearPicArr2(\''+ this.value +'\',\'\')">删除</a></li>';
			});			
