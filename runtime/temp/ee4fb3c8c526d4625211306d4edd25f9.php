<?php if (!defined('THINK_PATH')) exit(); /*a:3:{s:44:"./template/pc/rainbow/user\comment_list.html";i:1495621988;s:38:"./template/pc/rainbow/user\header.html";i:1495621988;s:46:"./template/pc/rainbow/public\footer_index.html";i:1495621986;}*/ ?>
<!DOCTYPE html>
<html>
<head>
    <meta charset="UTF-8">
...
//            showErrorMsg('ID: ' + this.id + "\nscore: " + score + "\nevent: " + evt);
    ...
    function add_img(str){
        ...
        {
            var tpl = '<span class="btn-upload comment_img" onclick="delimg(\'$IMG\',this)" ><input type="hidden" name="comment_img[]" value="$IMG"><img src="$IMG" border="0" alt=""></span>';
