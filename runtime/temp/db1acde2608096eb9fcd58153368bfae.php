<?php if (!defined('THINK_PATH')) exit(); /*a:1:{s:48:"./template/mobile/new2/user\ajax_order_list.html";i:1495621986;}*/ ?>
                            ...
                            <div class="deleshow fr">
                                ...
                                <div class="buttondde">
                                    <?php if(($list[return_btn] == 1) and ($good[is_send] < 2)): ?>
                                        <a href="<?php echo U('Mobile/User/return_goods',array('order_id'=>$list[order_id],'order_sn'=>$list[order_sn],'goods_id'=>$good[goods_id],'spec_key'=>$good['spec_key'])); ?>">申请售后</a>
