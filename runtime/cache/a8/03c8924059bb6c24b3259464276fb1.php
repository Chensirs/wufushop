<?php
//000000000000s:12055:"<div class="people-comment">
    <div class="deta-descri p">
        ...
        <div class="person-com">
            ...
            <div class="lifr4 requiimg p">
                                    <a href="/public/upload/goods/2016/04-19/5715eb1f78393.jpg" target="_blank"><img src="/public/upload/goods/2016/04-19/5715eb1f78393.jpg"/></a>
                                    <a href="/public/upload/goods/2016/04-19/5715eb3995d92.png" target="_blank"><img src="/public/upload/goods/2016/04-19/5715eb3995d92.png"/></a>
                                    <a href="/public/upload/goods/2016/04-19/5715eb397e45c.jpg" target="_blank"><img src="/public/upload/goods/2016/04-19/5715eb397e45c.jpg"/></a>
                            </div>
            <!--评论时间-->
    ...
    <!--点赞，回复-->
        <div class="g_come">
            ...
            <a  onclick="zan(this);"  data-comment-id="278"><i class="detai-ico z-ten"></i><span id="span_zan_278" data-io="0">0</span></a>
        </div>
    </div>
    <!--回复框-->
    <!--<div class="reply-textarea">-->
        ...
        <!--<div class="inner">-->
            <!--<textarea class="reply-input J-reply-input" data-id="replytext_278" placeholder="回复 ：" maxlength="120"></textarea>-->
...
<div class="people-comment">
    ...
    <!--点赞，回复-->
        <div class="g_come">
            <a href="javascript:void(0);"><i class="detai-ico c-cen"></i>0</a>
            <a  onclick="zan(this);"  data-comment-id="244"><i class="detai-ico z-ten"></i><span id="span_zan_244" data-io="0">0</span></a>
        </div>
    </div>
    <!--回复框-->
    <!--<div class="reply-textarea">-->
        <!--<div class="reply-arrow"><b class="layer1"></b><b class="layer2"></b></div>-->
        <!--<div class="inner">-->
            <!--<textarea class="reply-input J-reply-input" data-id="replytext_244" placeholder="回复 ：" maxlength="120"></textarea>-->
            <!--<div class="operate-box">-->
                <!--<span class="txt-countdown">还可以输入<em>120</em>字</span>-->
                <!--<a class="reply-submit J-submit-reply J-submit-reply-lz" href="javascript:void(0);" target="_self">提交</a>-->
            <!--</div>-->
...
<div class="people-comment">
    ...
    <!--点赞，回复-->
        <div class="g_come">
            <a href="javascript:void(0);"><i class="detai-ico c-cen"></i>0</a>
            <a  onclick="zan(this);"  data-comment-id="210"><i class="detai-ico z-ten"></i><span id="span_zan_210" data-io="0">0</span></a>
        </div>
    </div>
    <!--回复框-->
    <!--<div class="reply-textarea">-->
        <!--<div class="reply-arrow"><b class="layer1"></b><b class="layer2"></b></div>-->
        <!--<div class="inner">-->
            <!--<textarea class="reply-input J-reply-input" data-id="replytext_210" placeholder="回复 ：" maxlength="120"></textarea>-->
            <!--<div class="operate-box">-->
                <!--<span class="txt-countdown">还可以输入<em>120</em>字</span>-->
                <!--<a class="reply-submit J-submit-reply J-submit-reply-lz" href="javascript:void(0);" target="_self">提交</a>-->
            <!--</div>-->
